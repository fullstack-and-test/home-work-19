...
const testData = [
  [1, 10, "виводить випадкове число від 1 до 10"],
  [40, 50, "виводить випадкове число від 40 до 50"],
  [1, 100, "виводить випадкове число від 1 до 100"],
];

document.write(`<br /># 1. getRandomInt<br />`);

testData.forEach((test) => {
  const [min, max, expectedResult] = test;
  const actualResult = getRandomInt(min, max);
  document.write(
    `getRandomInt(min, max) as [${min}, ${max}] ${expectedResult} => ${actualResult}<br />`
  );
});
